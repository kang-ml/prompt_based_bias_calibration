...
class Trainer(transformers.Trainer):
    ...
    def train(self, test_mode=None, model_path=None, dev_objective=None):
        """
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                if (step + 1) % self.args.gradient_accumulation_steps == 0 or (
                    ...
                    if self.global_step % self.args.eval_steps == 0:
                        ...
                        print(f"Validation metric at global step {self.global_step}: {objective}")
                        ...
                        if objective > self.objective:
                            ...
                            self.save_model(os.path.join(self.args.output_dir, f'saved_model_{test_mode}'))
        ...
        if not os.path.isdir(val_path):
            os.mkdir(val_path)
        output_filename = os.path.join(val_path, f"{test_mode}_val_metric.json") 
